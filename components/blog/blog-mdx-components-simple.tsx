...
// Simple heading component without client-side features
...
function CustomPre({ children, ...props }: { children: ReactNode; className?: string; 'data-language'?: string }) {
  ...
  if (codeElement && codeElement.props && typeof codeElement.props === 'object') {
    ...
    if (typeof codeProps.children === 'string') {
      ...
      return <SimpleCodeBlock language={language}>{codeProps.children}</SimpleCodeBlock>;
    }
  }
...
export const SimpleBlogMDXComponents = {
  h1: createHeading(1),
  h2: createHeading(2),
  h3: createHeading(3),
  h4: createHeading(4),
